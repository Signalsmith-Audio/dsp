...
#define SIGNALSMITH_DSP_VERSION_PATCH 2
#define SIGNALSMITH_DSP_VERSION_STRING "1.4.2"
...
static_assert(SIGNALSMITH_DSP_VERSION_MAJOR == 1 && SIGNALSMITH_DSP_VERSION_MINOR == 4 && SIGNALSMITH_DSP_VERSION_PATCH == 2, "multiple versions of the Signalsmith DSP library");
#endif // include guard
